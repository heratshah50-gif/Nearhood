        ...
        <input
          ...
          className={`w-12 h-14 sm:w-14 sm:h-16 text-center text-xl sm:text-2xl font-bold rounded-xl border-2 transition-all outline-none ${
            disabled
              ...
              : digit
              ? "border-primary-400 bg-primary-50 text-neutral-800"
              : "border-neutral-200 bg-white text-neutral-800 focus:border-primary-400 focus:ring-4 focus:ring-primary-100"
          }`}
