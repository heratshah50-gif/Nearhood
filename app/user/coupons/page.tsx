          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-neutral-600">
                View and manage your available discount coupons and promotional codes.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-neutral-600 mb-8 max-w-md mx-auto">
                You don't have any coupons yet. Your available coupons and discount codes will appear here.
              </p>
            </motion.div>
          </div>
        </UserPanel>
