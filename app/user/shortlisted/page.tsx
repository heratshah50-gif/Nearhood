        ...
        <div className="min-h-screen flex items-center justify-center pt-32 pb-16">
          <div className="text-center">
            <p className="text-lg text-neutral-600 mb-4">
              Please log in to view your shortlisted items
            </p>
            <button
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-neutral-600">
                View your saved properties and vehicles that you've shortlisted for later.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-neutral-600 mb-8 max-w-md mx-auto">
                You haven't shortlisted any items yet. Start exploring properties and vehicles to add them to your shortlist.
              </p>
