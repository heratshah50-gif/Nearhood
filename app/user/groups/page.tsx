          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-neutral-600">
                View and manage the bulk buying groups you've joined.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-neutral-600 mb-8 max-w-md mx-auto">
                You haven't joined any bulk buying groups yet. Browse available properties and vehicles to join a group and get the best deals.
              </p>
