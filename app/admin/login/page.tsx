...
import { ShieldCheck, Lock, Mail, Loader2, ArrowLeft, Shield } from "lucide-react";
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <span className="block text-sm text-primary-600 font-medium">Admin Portal</span>
            </div>
          </Link>
        </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-6 p-4 bg-primary-50 border border-primary-100 rounded-xl">
              ...
              <p className="text-sm text-primary-600">
                Email: <span className="font-medium">admin@nearhood.com</span>
              </p>
              <p className="text-sm text-primary-600">
