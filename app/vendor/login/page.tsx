      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 text-[#1e3a5f] font-bold text-xl">
            ...
            <span>Nearhood</span> <span className="text-neutral-500">Vendor</span>
          </Link>
        </div>
        <div className="bg-white rounded-2xl shadow-xl border border-neutral-200 p-8">
          ...
          <p className="text-neutral-500 text-sm mb-6">Sign in to manage your properties, inquiries, and deals.</p>
          ...
          <p className="mt-4 text-center text-neutral-500 text-xs">
            Demo: vendor@nearhood.com / vendor123
          </p>
        </div>
