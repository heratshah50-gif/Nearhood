...
import { Search, Plus, Upload, X, ArrowLeft, Building2 } from "lucide-react";
    ...
    <div className="space-y-5 relative">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <select
          ...
          className="px-4 py-2.5 rounded-xl border-2 border-neutral-200 bg-white text-sm text-neutral-700 focus:outline-none focus:ring-4 focus:ring-primary-100 focus:border-primary-400"
        >
